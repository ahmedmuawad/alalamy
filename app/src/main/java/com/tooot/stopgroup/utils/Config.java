...
public class Config {
    ...
    public static final String LANGUAGE = "ar";             // set Your Language Here
    ...
    public static boolean OTPVerification = false; //set true when you want to disable OTP verification  and active OTP verification
