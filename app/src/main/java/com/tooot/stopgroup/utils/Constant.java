...
import com.tooot.stopgroup.model.Sort;
...
public class Constant {
    ...
    public static final String MyPREFERENCES = "com.tooot.stopgroup"; // Add your package name

    public static final String PACKAGE_NAME = "com.tooot.stopgroup";  // Add your package name

    public static final String DeepLinkDomain = "example.page.link";// Add your Deeplink Domain URL

    public static final String DynamicLinkIosParameters = "com.tooot.stopgroup"; // Add your Deeplink IOS package name if you have
