...
import com.tooot.stopgroup.adapter.ColorAdapter;
import com.tooot.stopgroup.adapter.FilterTypeAdapter;
import com.tooot.stopgroup.customview.EqualSpacingItemDecoration;
import com.tooot.stopgroup.customview.rangeseekbar.interfaces.OnRangeSeekbarChangeListener;
import com.tooot.stopgroup.customview.rangeseekbar.interfaces.widgets.CrystalRangeSeekbar;
...
import com.tooot.stopgroup.javaclasses.FilterSelectedList;
import com.tooot.stopgroup.model.FilterColorOption;
import com.tooot.stopgroup.model.FilterOtherOption;
import com.tooot.stopgroup.model.PriceFilter;
...
public class FilterActivity extends BaseActivity implements OnItemClickListner, OnResponseListner {
    ...
    @BindView(R.id.tvMin)
    TextViewMedium tvMin;

    @BindView(R.id.tvMax)
    TextViewMedium tvMax;

    @BindView(R.id.tvPriceTitle)
    TextViewRegular tvPriceTitle;
    ...
    public void setColorTheme() {
        setTextViewDrawableColors(tvcolorTitle, Color.parseColor(getPreferences().getString(Constant.SECOND_COLOR, Constant.SECONDARY_COLOR)));
        tvcolorTitle.setTextColor(Color.parseColor(getPreferences().getString(Constant.SECOND_COLOR, Constant.SECONDARY_COLOR)));
        ...
        tvPriceTitle.setTextColor(Color.parseColor(getPreferences().getString(Constant.SECOND_COLOR, Constant.SECONDARY_COLOR)));

        Drawable unwrappedDrawable = tvClearFilter.getBackground();
    ...
    public void setColorAdapter() {
        ...
        rvColor.addItemDecoration(new EqualSpacingItemDecoration(dpToPx(10), EqualSpacingItemDecoration.HORIZONTAL)); // 16px. In practice, you'll want to use getDimensionPixelSize
