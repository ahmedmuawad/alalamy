...
import com.tooot.stopgroup.adapter.IntroViewPagerAdapter;
        ...
        vpIntro.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (currentPosition == 2) {
                    ...
                    tvNext.setTextColor(Color.parseColor(getPreferences().getString(Constant.SECOND_COLOR, Constant.SECONDARY_COLOR)));
                } else {
