...
import com.tooot.stopgroup.adapter.MyPointSAdapter;
...
import com.tooot.stopgroup.model.MyPoint;
...
public class MyPointActivity extends BaseActivity implements OnItemClickListner, OnResponseListner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvMyPoint.setTextColor(Color.parseColor(getPreferences().getString(Constant.SECOND_COLOR, Constant.SECONDARY_COLOR)));
    }
