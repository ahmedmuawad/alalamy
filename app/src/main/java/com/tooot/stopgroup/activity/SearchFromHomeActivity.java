...
import com.tooot.stopgroup.adapter.SearchHomeAdapter;
...
import com.tooot.stopgroup.model.SearchLive;
...
public class SearchFromHomeActivity extends BaseActivity implements OnItemClickListner {
    ...
    private void setThmecolor() {
        line.setBackgroundColor(Color.parseColor(getPreferences().getString(Constant.SECOND_COLOR, Constant.SECONDARY_COLOR)));
        etSearch.setTextColor(Color.parseColor(getPreferences().getString(Constant.SECOND_COLOR, Constant.SECONDARY_COLOR)));
        etSearch.setHintTextColor(Color.parseColor(getPreferences().getString(Constant.APP_TRANSPARENT_VERY_LIGHT, Constant.SECONDARY_COLOR)));
