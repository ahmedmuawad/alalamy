...
import com.tooot.stopgroup.adapter.SellerProductAdapter;
                ...
                try {
                    ...
                    if (loading) {
                        ...
                        if (sellerDataRider.sellerInfo.bannerUrl != null && sellerDataRider.sellerInfo.bannerUrl.length() > 0) {
                            ...
                            Picasso.get().load(bannerUrl).error(R.drawable.male).into(ivBannerImage);
                        } else {
                        ...
                        if (sellerDataRider.sellerInfo.avatar != null && sellerDataRider.sellerInfo.avatar.length() > 0) {
                            ...
                            Picasso.get().load(sellerDataRider.sellerInfo.avatar.replace("\\", "")).into(civProfileImage);
                        } else {
                            ivBannerImage.setVisibility(View.INVISIBLE);
                        }
