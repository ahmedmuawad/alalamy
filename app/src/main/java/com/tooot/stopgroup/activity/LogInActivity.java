...
import com.tooot.stopgroup.customview.edittext.EditTextMedium;
...
import com.tooot.stopgroup.model.LogIn;
...
public class LogInActivity extends BaseActivity implements GoogleApiClient.OnConnectionFailedListener, OnResponseListner {
    ...
    TextViewBold tvForgetPass;

    @BindView(R.id.tvSignIn)
    TextViewBold tvSignIn;

    @BindView(R.id.tvNewUser)
    TextViewRegular tvNewUser;
    ...
    public void setColor() {
        tvNewUser.setTextColor(Color.parseColor(getPreferences().getString(Constant.SECOND_COLOR, Constant.SECONDARY_COLOR)));
        Drawable unwrappedDrawable = tvSignIn.getBackground();
        ...
        tvForgetPass.setTextColor(Color.parseColor(getPreferences().getString(Constant.SECOND_COLOR, Constant.SECONDARY_COLOR)));
    ...
    @OnClick(R.id.ivLoginWithGoogle)
    public void ivLoginWithGoogleClick() {
    ...
    @OnClick(R.id.ivLoginWithFacebook)
    public void ivLoginWithFacebookClick() {
