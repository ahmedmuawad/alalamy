...
import com.tooot.stopgroup.BuildConfig;
...
public class AboutUsActivity extends BaseActivity implements OnResponseListner {
    ...
    TextViewLight tvCopyRight;

    @BindView(R.id.tvFollowUs)
    TextViewBold tvFollowUs;
    ...
    public void setColorTheme() {
        tvTermsAndCondition.setTextColor(Color.parseColor(getPreferences().getString(Constant.SECOND_COLOR, Constant.SECONDARY_COLOR)));
        tvPrivacyPolicy.setTextColor(Color.parseColor(getPreferences().getString(Constant.SECOND_COLOR, Constant.SECONDARY_COLOR)));
        ...
        tvCopyRight.setTextColor(Color.parseColor(getPreferences().getString(Constant.SECOND_COLOR, Constant.SECONDARY_COLOR)));
        tvVersion.setTextColor(Color.parseColor(getPreferences().getString(Constant.SECOND_COLOR, Constant.SECONDARY_COLOR)));

        tvFollowUs.setTextColor(Color.parseColor(getPreferences().getString(Constant.SECOND_COLOR, Constant.SECONDARY_COLOR)));
        tvMoreAboutUs.setTextColor(Color.parseColor(getPreferences().getString(Constant.SECOND_COLOR, Constant.SECONDARY_COLOR)));
    }
