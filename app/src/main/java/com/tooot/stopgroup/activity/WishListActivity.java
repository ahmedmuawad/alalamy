...
import com.tooot.stopgroup.adapter.WishListAdapter;
...
public class WishListActivity extends BaseActivity implements OnItemClickListner, OnResponseListner {
    ...
    private void setThemeColor() {
        tvNoOfItems.setTextColor((Color.parseColor(getPreferences().getString(Constant.SECOND_COLOR, Constant.SECONDARY_COLOR))));
    ...
    public void setWishListAdapter() {
        ...
        svWishList.setOnScrollChangeListener((NestedScrollView.OnScrollChangeListener) (v, scrollX, scrollY, oldScrollX, oldScrollY) -> {
...
//        });
    ...
    public void onItemClick(int position, String value, int outerPos) {
        ...
        tvNoOfItems.setText((outerPos-1) + " " + getString(R.string.items));
        ...
        if (methodName.equals(RequestParamUtils.getWishListData)) {
            ...
            if (response != null && response.length() > 0) {
                try {
                    ...
                    tvNoOfItems.setText(list.size() + " " + getString(R.string.items));
