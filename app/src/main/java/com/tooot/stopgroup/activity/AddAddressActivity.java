...
public class AddAddressActivity extends BaseActivity implements OnResponseListner {
    ...
    public void setThemeColor() {
        ...
        //tv cancel
        Drawable tvcanceladdressdrawable = tvCancel.getBackground();
        ...
        tvActivityTitle.setTextColor(Color.parseColor(getPreferences().getString(Constant.SECOND_COLOR, Constant.SECONDARY_COLOR)));
    }
