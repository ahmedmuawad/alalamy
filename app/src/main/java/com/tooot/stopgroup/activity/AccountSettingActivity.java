...
public class AccountSettingActivity extends BaseActivity implements OnResponseListner {
    ...
    public void setThemeColor() {
        icGoOne.setColorFilter(Color.parseColor(getPreferences().getString(Constant.SECOND_COLOR, Constant.SECONDARY_COLOR)));
        ivGo.setColorFilter(Color.parseColor(getPreferences().getString(Constant.SECOND_COLOR, Constant.SECONDARY_COLOR)));
        tvDeactivateAccount.setTextColor(Color.parseColor(getPreferences().getString(Constant.SECOND_COLOR, Constant.SECONDARY_COLOR)));
        tvChangePassword.setTextColor(Color.parseColor(getPreferences().getString(Constant.SECOND_COLOR, Constant.SECONDARY_COLOR)));
        Drawable unwrappedDrawable = tvSave.getBackground();
...
//                });
        ...
        lastDayOfNextYear.add(Calendar.YEAR, -8);
        lastDayOfNextYear.set(Calendar.DATE, lastDayOfNextYear.get(Calendar.DATE));
        lastDayOfNextYear.set(Calendar.MONTH, lastDayOfNextYear.get(Calendar.MONTH));
        datePickerDialog.getDatePicker().setMaxDate(lastDayOfNextYear.getTimeInMillis());
